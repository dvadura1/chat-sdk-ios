...
-(RXPromise *) sendMessageWithImage:(UIImage *)image withThreadEntityID:(NSString *)threadID {
    ...
    return [BChatSDK.upload uploadFile:UIImageJPEGRepresentation(resizedImage, 0.8) withName:@"image.jpg" mimeType:@"image/jpeg" message: message].thenOnMain(^id(NSDictionary * info) {
